...
**Note**: Because Notre Dame University is missing `term_units` and `zterm_units_zof_z` observations, we excluded NDU from the final statistical modelling. For exploratory analysis looking at student demogrpahics and sleeping patterns, we included all possible observations. 
