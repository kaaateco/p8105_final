...
More information on data collection can be found at [this site](https://cmustatistics.github.io/data-repository/psychology/cmu-sleep.html) and the data can be downloaded directly from [this link](https://cmustatistics.github.io/data-repository/data/cmu-sleep.csv). 

---

# Variable Descriptions 

The descriptions below were taken directly from the CMU S&DS Data Repository:
