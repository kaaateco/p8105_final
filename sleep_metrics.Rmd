...
The group getting the least amount of sleep seem to be the 1.5-2.0 GPA students. Starting at the bottom left of the heat map and moving to the upper right, the total sleep time of students increases. 
...
Variability in bed times are relatively even across all GPA and term unit groups. For the lower GPA students (less than 3.0) with roughly average course loads, there is slightly greater variability. 
...
There isn't much of a distinct trend in daytime sleep between GPA and course unit groups. Overall, time spent sleeping during the day is relatively low, with students with average course loads and GPAs having more daytime sleep. 
