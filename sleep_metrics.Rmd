...
at this point I'm not sure If i can use gt summary to test (kruskal wallis?? I guess all the variables aren't normal...)
...
anova(lm(midpoint_sleep ~ university, sleep_df)) %>% broom::tidy()
...
As would be expected, our different measures of sleep behavior are not independent of each other. The Pearson correlation coefficients calculated in the matrix below indicate that several of the variables are considerably correlated with each other. 

Total Sleep Time is moderately negatively correlated with Daytime Sleep (-0.29) and Sleeping Midpoint (-0.33). This makes sense, as we would expect that as the amount of sleep someone gets at night increases, they would spend less time sleeping during the day and are probably going to bed earlier. Sleeping Midpoint and Bedtime Variability are quite positively correlated (0.41), which also makes sense, since more sporadic sleeping schedules are typically explained by staying up late.
...
The plot below describes the density of students at different cumulative GPA and course load levels. The most dense single section of the heat map shows that many students have about a 3.75 GPA and a slightly above average amount of course units. Most of the plot shows a steady decrease in density centered and skewed left around this peak. 

Interestingly, there is also one additional (and much shorter) peak on the plot, which is of students with roughly 3.75 GPAs, but taking an amount of units that is roughly 1.5 standard deviations above average. This indicates that there is a moderately-sized group of over-achieving students, with very high GPAs and course loads. 
...
The group getting the least amount of sleep seem to be the 1.5-2.0 GPA students. Starting at the bottom left of the heat map and moving to the upper right, the total sleep time of students seems to increase. 
...
Variability in bed times are relatively even across all GPA and term unit groups. For the lower GPA students (less than 3.0) with roughly average course loads, there seems to be slightly greater variability. 
...
In the map below, it's obvious that students with greater GPAs (3.5-4.0) and heavier course loads (greater than 1 SD above average) have sleeping midpoints that are mostly within 6 hours of 11 PM. As we move from the upper-right to the lower-left of the plot, we can clearly see that the sleeping midpoint times gradually become later in the night. 

This trend implies that higher-GPA and higher-unit students are going to sleep earlier/waking up earlier than their peers. 
...
There isn't much of a distinct trend in daytime sleep between GPA and course unit groups. Overall, time spent sleeping during the day is relatively low, with students with average course loads and lower GPAs napping slightly more than others. 
...
We can clearly see that the male and female students have distinct peaks in their distributions of sleeping midpoint, with the majority of men having a midpoint at ~250 minutes past 11 PM ()
